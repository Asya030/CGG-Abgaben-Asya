...
public class PolishedMetalMaterial implements Material {
    ...
    double reflectionCoefficient;
     ...
     public PolishedMetalMaterial(Sampler texture, double reflectionCoefficient) {
        this.texture = texture;
    }

    public PolishedMetalMaterial(Color color,double reflectionCoefficient){
        this.texture = new ConstantColor(color);
    }
