...
public class GlassMaterial implements Material {
    ...
    public Ray scattered(Ray ray, Hit hit) {
        ...
        Direction normal = Vector.normalize(hit.normalenvektor());
        // Direction of the ray
        Direction direction = ray.d();
        /**
        ...
        return new Ray(hit.trefferpunktX(), scattered, 0.0001, Double.POSITIVE_INFINITY);
    }
